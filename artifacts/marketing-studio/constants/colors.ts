...
const DARK_NAVY = "#000000";
const NAVY_LIGHT = "#1A1A1A";
const NAVY_MEDIUM = "#2A2A2A";
const SURFACE_DARK = "#111111";
const WHITE = "#FFFFFF";
const GRAY_100 = "#F8FAFC";
const GRAY_200 = "#E2E8F0";
const GRAY_300 = "#94A3B8";
const GRAY_400 = "#64748B";
...
export default {
  light: {
    ...
    surfaceElevated: NAVY_LIGHT,
    surfaceHigh: NAVY_MEDIUM,
    tint: SA_GOLD,
